...
startIIP() {
	...
	docker run -d --name systemone-iipimageserver$ENV_SUFFIX \
	 ...
	 --mount type=bind,source=sharedFileStorage$SHARED_FILE_SUFFIX,target=/tmp/sharedFileStorage/systemOne,readonly \
