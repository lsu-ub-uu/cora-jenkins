...
echo "Kill dockers"
docker kill alvin-rabbitmq alvin-smallImageConverter alvin-jp2Converter alvin-pdfConverter \
 alvin-fitnesse alvin alvin-fedora alvin-postgresql alvin-solr alvin-idplogin \
 alvin-apptokenverifier alvin-gatekeeper && echo nothingToSeeMoveOnToNextCommand
echo ""
echo "Remove dockers"
docker rm alvin-rabbitmq alvin-smallImageConverter alvin-jp2Converter alvin-pdfConverter \
alvin-fitnesse alvin alvin-fedora alvin-postgresql alvin-solr alvin-idplogin \
alvin-apptokenverifier alvin-gatekeeper && echo nothingToSeeMoveOnToNextCommand
echo ""
echo "Remove volumes"
...
docker run -d --net=$NETWORK --name alvin-rabbitmq \
...
docker run -d --name alvin-fitnesse \
 ...
 $NETWORK-docker-fitnesse:1.1-SNAPSHOT
